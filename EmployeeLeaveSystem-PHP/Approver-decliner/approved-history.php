<?php
    ...
    if(strlen($_SESSION['alogin'])==0){   
        ...
        // Fetch admin role from the session
$role = $_SESSION['role'];

// For processing leave requests
if ($role == 'processor') {
    // Code to process leave requests
}

// For approving leave requests
if ($role == 'approver') {
        ...
        <div class="sidebar-menu">
            ...
            <div class="main-menu">
                <div class="menu-inner">
                    <?php
                        $page='manage-leave';
                        include '../Approver-decliner/includes1/admin-sidebar.php';
                    ?>
                </div>
            </div>
        </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown">App/Dec <i class="fa fa-angle-down"></i></h4>
