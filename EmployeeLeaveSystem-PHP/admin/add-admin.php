...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['add'])) {
        ...
        $sql = "INSERT INTO admin(fullname, email, Password, UserName, role) VALUES(:fullname, :email, :password, :username, :role)";
        ...
        $query->bindParam(':role', $role, PDO::PARAM_STR); // Add this line
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Add HEAD DEPT Section</h4>
                            <ul class="breadcrumbs pull-left"> 
                                <li><a href="manage-admin.php">Manage HEAD DEPT</a></li>
                                <li><span>Add</span></li>
