    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="leave.php"><img src="../assets/images/icon/logo.jpg" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="empcode" type="text" autocomplete="off" <?php echo htmlentities($result->EmpId);?>" id="example-text-input">
                                        </div>
                                        <div class="form-group">
